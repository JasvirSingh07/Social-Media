    ...
    details: [
      {
        ...
        subDetails: [{ title: "Allow tags from everyone" ,icon:<RiCheckboxBlankCircleLine className="lg:lg:text-2xl" />},
        { title: "Allow tags from people you follow",icon:<RiCheckboxBlankCircleLine className="lg:lg:text-2xl" />},
        { title: "Don't allow tags",icon: <RiCheckboxBlankCircleLine className="lg:lg:text-2xl" /> }]
      },
      {
        title: "Who can @mention you", info: "Choose who can @mention you to link your account in their stories, comments, live videos, and captions. When people try to @mention you, they'll see if you don't allow @mentions.", subDetails: [{ title: "Allow mentions from everyone",icon: <RiCheckboxBlankCircleLine className="lg:text-2xl" /> },
        { title: "Allow mentions from people you follow" ,icon: <RiCheckboxBlankCircleLine className="lg:text-2xl" />}, { title: "Don't allow mentions" ,icon: <RiCheckboxBlankCircleLine className="lg:text-2xl" />}]
      },
