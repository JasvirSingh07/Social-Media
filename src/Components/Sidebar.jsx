...
// import logo from "/logo/pixgram.jpg"
import {
  FaHome,
  FaSearch,
  FaCompass,
...
const Sidebar = () => {
  ...
  const dropdownItems = [
    ...
    { icon: <FaSun />, label: "Switch Appearance", },
    {
    ...
    <div className="flex flex-col h-screen tracking-wide  w-full">
      ...
      <div className={`lg:flex flex-col lg:space-y-3 sm:overflow-y-auto scrollbar-hide`}>
        ...
        <div className="flex items-center sm:p-2 mt-4 mb-6 lg:mt-6 ">
          ...
          <h1 className="text-[3vw] xl:text-4xl tracking-wide font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#554295] via-[#EE2D31] to-[#F79421] font-cursive">
            PixGram
          </h1>
        </div>
            ...
            {menuItems.map((item, index) => (
              <div key={index}>
                ...
                {item.label === "More" && isDropdownOpen && (
                  <div className="bg-gray-100 text-black rounded-md mt-2 w-full p-2">
